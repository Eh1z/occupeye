...
type CCTVClientProps = {
  role: AuthRole
}

export default function CCTVClient({ role }: CCTVClientProps) {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-slate-50 dark:bg-slate-950">
      <div className="border-b border-slate-200 bg-white px-4 py-3 dark:border-slate-800 dark:bg-slate-900 md:px-6">
        <div className="flex items-center justify-between gap-3">
          <div>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400">Lecturer and admin monitoring tools</p>
          </div>
      ...
      <div className="flex flex-1 flex-col gap-4 overflow-hidden p-4 md:p-6">
        {selectedRoom && (
          <div className="flex shrink-0 items-center gap-3 rounded-lg border border-slate-200 bg-white p-3 dark:border-slate-700 dark:bg-slate-900">
